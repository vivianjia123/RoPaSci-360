...
from random_player.heuristics import *
from random_player.pathfinding import *
...
class Player:
    ...
    def action(self):
        ...
        """
        action_list = gen_potential_actions(self.player_pos, self.opponent_pos, self.my_throw_range, self.my_throws_left, self.player)
        decision = make_decision(action_list)
        if decision[0] == "THROW":
            return decision
    ...
    def update(self, opponent_action, player_action):
        ...
        if player_action[0] == "THROW":
            ...
            #print("**Debuging-1.1 self")
            for position in self.player_pos:
                if position[1] == player_action[1]:
                    #print("**Debuging Position:", position, player_action)
